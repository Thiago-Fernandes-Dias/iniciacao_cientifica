...
Para os experimentos iniciais com os conjuntos de dados encontrados foram feitas buscas por códigos disponíveis publicamente ou modelos pré-treinados que poderiam ter sido disponibilizados publicamente pelos autores dos artigos lidos na revisão bibliográfica, o que elimina a necessidade de implementação das técnicas e de treinamento de modelos. Até o momento foram feitos experimentos com uma implementação do modelo DeepPrint feita por~\citeonline{Rohwedder2023}
