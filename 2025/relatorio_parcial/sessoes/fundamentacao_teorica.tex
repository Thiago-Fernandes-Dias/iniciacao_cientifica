...
\citeonline{finterget} desenvolveram o~\textit{FingerNet}, uma CNN que extraí mapas de minúcias, de segmentação e orientação dos cumes, além de aplicar o realce nas digitais.
