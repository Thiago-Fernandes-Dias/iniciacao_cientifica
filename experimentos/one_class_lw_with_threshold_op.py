...
def main() -> None:
    ...
    one_class_lw_gs = GridSearchCV(LightWeightAlg(), lw_params_grid_var_t, 
                                    scoring=far_score, cv=one_class_lw_grid_cv, n_jobs=-1)
    one_class_lw_with_hpo_experiment = OneClassExperimentWithSearchCVRunnerImpl(dataset=cmu_database,
